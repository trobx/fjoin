...
Extends `r pkg("data.table")` join functionality and provides a familiar
`x`/`y`-style interface that works directly on any data frames. Provides NA-safe
matching by default, on-the-fly column selection, flexible row-order
